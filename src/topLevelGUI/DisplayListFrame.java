...
public class DisplayListFrame extends JFrame {

	public DisplayListFrame(DisplayRegistry displayReg)  {
		super("Available Displays");
		...
		List<Display> parsers = displayReg.getAllDisplays();
		...
		JLabel lab = new JLabel("" + parsers.size() + " displays registered");
		bottomPanel.add(lab);
